<template>
    <app-layout title="Sucursal" :sucursal="sucursal">
        ...
        <div class="py-12">
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <sucursal :sucursal="sucursal" :areas="areas" :tareas="tareas" :rol="user.role"/>
                </div>
            </div>
        </div>
    </app-layout>
...
<script>
    ...
    import Sucursal from '@/Jetstream/Sucursal.vue'
    ...
    export default defineComponent({
        ...
        props:['user','sucursal','tareas','areas'],
        mounted(){
