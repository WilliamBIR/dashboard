<template>
    <app-layout title="Area" :sucursal="sucursal" :area="area">
        ...
        <div class="py-12">
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <jet-area :modelos="modelos" :tmodelos="tmodelos" :area="area"/>
                </div>
            </div>
        </div>
    </app-layout>
...
<script>
    ...
    import JetArea from '@/Jetstream/Area.vue';
    ...
    export default defineComponent({
        ...
        props:['user','modelos','sucursal','tmodelos','area'],
        mounted(){
            if(!this.$inertia.path){
                ...
                this.$inertia.auth = ()=>{
                    ...
                    // Envio desde IPK 
                    this.$inertia.socket.on("failureCbIPK", function (args) {
                        console.log(args);
                    });
                    this.$inertia.socket.on("successCbIPK", function (args) {
